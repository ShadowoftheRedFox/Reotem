...
À noté, sur Unix, il faut créer un dossier [logs](./back/logs) afin de créer les fichiers de logs, un dossier [dump](./back/dump) afin de créer les fichiers de backup de la BDD.  
